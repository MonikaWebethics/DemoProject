        ...
        <div class="row">
            <div id="user-profile" class="col-lg-4 col-md-4 col-sm-12 me-lg-5 me-md-3 py-5" style="background-color: #F2F2F2;">
                <div class="user-main">
                    ...
                    <h2 class="text-center pt-2" id="name">{{ auth()->user()->fname }} {{ auth()->user()->lname }}</h2>
                    <h6 class="text-user text-center pt-2" id="email">{{ auth()->user()->email }}</h6>
                    <h6 class="text-user text-center pt-2" id="country1">{{ auth()->user()->country }}</h6>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 p-5" style="background-color: #F2F2F2;">
                <div class="row userfont">
                    ...
                    <div class="col-6 pt-lg-5 ps-lg-0 ps-4 fs-5 fw-normal" id="first-name">{{ auth()->user()->fname }}</div>
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal"> Last name </div>
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal" id="last-name">{{ auth()->user()->lname }}</div>
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal">Gender </div>
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal" id="gender">{{ auth()->user()->gender }}</div>
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal">Country</div>
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal" id="country">{{ auth()->user()->country }}
                    </div>
                    {{-- <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal">State</div>
     <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal" id="state">H.P.</div> --}}
                    ...
                    <div class="col-6 pt-lg-3 ps-lg-0 ps-4 fs-5 fw-normal" id="hobbies">
                        {{ implode(', ', json_decode(auth()->user()->hobbies)) }}</div>
